(function () {
    ...
    l = function () {
        ...
        function n(e, t) {
            ...
            if (n.instances.push(this), this.element.dropzone = this, i = null != (o = n.optionsForElement(this.element)) ? o : {}, this.options = r({}, this.defaultOptions, i, null != t ? t : {}), this.options.forceFallback || !n.isBrowserSupported()) return this.options.fallback.call(this);
            if (null == this.options.url && (this.options.url = this.element.getAttribute("action")), !this.options.url) throw new Error("No URL provided.");
            if (this.options.acceptedFiles && this.options.acceptedMimeTypes) throw new Error("You can't provide both 'acceptedFiles' and 'acceptedMimeTypes'. 'acceptedMimeTypes' is deprecated.");
            this.options.acceptedMimeTypes && (this.options.acceptedFiles = this.options.acceptedMimeTypes, delete this.options.acceptedMimeTypes), this.options.method = this.options.method.toUpperCase(), (s = this.getExistingFallback()) && s.parentNode && s.parentNode.removeChild(s), !1 !== this.options.previewsContainer && (this.options.previewsContainer ? this.previewsContainer = n.getElement(this.options.previewsContainer, "previewsContainer") : this.previewsContainer = this.element), this.options.clickable && (!0 === this.options.clickable ? this.clickableElements = [this.element] : this.clickableElements = n.getElements(this.options.clickable, "clickable")), this.init()
        }

        var r, s;
        return p(n, e), n.prototype.Emitter = t, n.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], n.prototype.defaultOptions = {
            url: null,
            method: "post",
            withCredentials: !1,
            timeout: 3e4,
            ...
            fallback: function () {
                var e, t, i, r, s, o;
                for (this.element.className = this.element.className + " dz-browser-not-supported", t = 0, i = (s = this.element.getElementsByTagName("div")).length; t < i; t++) e = s[t], /(^| )dz-message($| )/.test(e.className) && (r = e, e.className = "dz-message");
                return r || (r = n.createElement('<div class="dz-message"><span></span></div>'), this.element.appendChild(r)), (o = r.getElementsByTagName("span")[0]) && (null != o.textContent ? o.textContent = this.options.dictFallbackMessage : null != o.innerText && (o.innerText = this.options.dictFallbackMessage)), this.element.appendChild(this.getFallbackForm())
            },
            resize: function (e, t, i, n) {
                ...
                if (r = {
                    ...
                    srcWidth: e.width,
                    srcHeight: e.height
                }, s = e.width / e.height, null == t && null == i ? (t = r.srcWidth, i = r.srcHeight) : null == t ? t = i * s : null == i && (i = t / s), t = Math.min(t, r.srcWidth), i = Math.min(i, r.srcHeight), o = t / i, r.srcWidth > t || r.srcHeight > i) if ("crop" === n) s > o ? (r.srcHeight = e.height, r.srcWidth = r.srcHeight * o) : (r.srcWidth = e.width, r.srcHeight = r.srcWidth / o); else {
            ...
            addedfile: function (e) {
                ...
                if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                    for (e.previewElement = n.createElement(this.options.previewTemplate.trim()), e.previewTemplate = e.previewElement, this.previewsContainer.appendChild(e.previewElement), t = 0, s = (a = e.previewElement.querySelectorAll("[data-dz-name]")).length; t < s; t++) a[t].textContent = this._renameFilename(e.name, e);
                    for (i = 0, o = (u = e.previewElement.querySelectorAll("[data-dz-size]")).length; i < o; i++) u[i].innerHTML = this.filesize(e.size);
                    for (this.options.addRemoveLinks && (e._removeLink = n.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>' + this.options.dictRemoveFile + "</a>"), e.previewElement.appendChild(e._removeLink)), c = function (t) {
                        return function (i) {
                    ...
                    }(this), h = [], r = 0, l = (p = e.previewElement.querySelectorAll("[data-dz-remove]")).length; r < l; r++) d = p[r], h.push(d.addEventListener("click", c));
                    return h
                }
            },
            ...
            var e, t, i, r, s;
            for (s = [], t = 0, i = (r = this.files).length; t < i; t++) (e = r[t]).status !== n.UPLOADING && e.status !== n.QUEUED || s.push(e);
            return s
        }, n.prototype.init = function () {
            var e, t, i, r, s, o, l;
            for ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(n.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")), this.clickableElements.length && (l = function (e) {
                return function () {
                    return e.hiddenFileInput && e.hiddenFileInput.parentNode.removeChild(e.hiddenFileInput), e.hiddenFileInput = document.createElement("input"), e.hiddenFileInput.setAttribute("type", "file"), (null == e.options.maxFiles || e.options.maxFiles > 1) && e.hiddenFileInput.setAttribute("multiple", "multiple"), e.hiddenFileInput.className = "dz-hidden-input", null != e.options.acceptedFiles && e.hiddenFileInput.setAttribute("accept", e.options.acceptedFiles), null != e.options.capture && e.hiddenFileInput.setAttribute("capture", e.options.capture), e.hiddenFileInput.style.visibility = "hidden", e.hiddenFileInput.style.position = "absolute", e.hiddenFileInput.style.top = "0", e.hiddenFileInput.style.left = "0", e.hiddenFileInput.style.height = "0", e.hiddenFileInput.style.width = "0", document.querySelector(e.options.hiddenInputContainer).appendChild(e.hiddenFileInput), e.hiddenFileInput.addEventListener("change", function () {
                        var t, i, n, r;
                        if ((i = e.hiddenFileInput.files).length) for (n = 0, r = i.length; n < r; n++) t = i[n], e.addFile(t);
                        return e.emit("addedfiles", i), l()
                    })
                }
            }(this))(), this.URL = null != (s = window.URL) ? s : window.webkitURL, t = 0, i = (o = this.events).length; t < i; t++) e = o[t], this.on(e, this.options[e]);
        ...
        }, n.prototype._renameFilename = function (e, t) {
            return "function" != typeof this.options.renameFilename ? e : this.options.renameFilename(e, t)
        }, n.prototype.getFallbackForm = function () {
            var e, t, i, r;
            return (e = this.getExistingFallback()) ? e : (i = '<div class="dz-fallback">', this.options.dictFallbackText && (i += "<p>" + this.options.dictFallbackText + "</p>"), i += '<input type="file" name="' + this._getParamName(0) + '" ' + (this.options.uploadMultiple ? 'multiple="multiple"' : void 0) + ' /><input type="submit" value="Upload!"></div>', t = n.createElement(i), "FORM" !== this.element.tagName ? (r = n.createElement('<form action="' + this.options.url + '" enctype="multipart/form-data" method="' + this.options.method + '"></form>')).appendChild(t) : (this.element.setAttribute("enctype", "multipart/form-data"), this.element.setAttribute("method", this.options.method)), null != r ? r : t)
            ...
            var t, i, n, r, s, o, l, a;
            if (s = 0, o = "b", e > 0) {
                for (i = n = 0, r = (a = ["TB", "GB", "MB", "KB", "b"]).length; n < r; i = ++n) if (l = a[i], t = Math.pow(this.options.filesizeBase, 4 - i) / 10, e >= t) {
                    s = e / Math.pow(this.options.filesizeBase, 4 - i), o = l;
                    break
                }
                s = Math.round(10 * s) / 10
            }
            return "<strong>" + s + "</strong> " + o
            ...
            var e;
            if (!this._processingThumbnail && 0 !== this._thumbnailQueue.length) return this._processingThumbnail = !0, e = this._thumbnailQueue.shift(), this.createThumbnail(e, this.options.thumbnailWidth, this.options.thumbnailHeight, this.options.thumbnailMethod, !0, function (t) {
                return function (i) {
            ...
            var t, i, r, s;
            for (null == e && (e = !1), i = 0, r = (s = this.files.slice()).length; i < r; i++) ((t = s[i]).status !== n.UPLOADING || e) && this.removeFile(t);
            return null
        }, n.prototype.resizeImage = function (e, t, r, s, o) {
            return this.createThumbnail(e, t, r, s, !1, function (t) {
                return function (r, s) {
                    var l, a;
                    return null === s ? o(e) : (null == (l = t.options.resizeMimeType) && (l = e.type), a = s.toDataURL(l, t.options.resizeQuality), "image/jpeg" !== l && "image/jpg" !== l || (a = i.restore(e.dataURL, a)), o(n.dataURItoBlob(a)))
                }
            }(this))
            ...
            return a = document.createElement("img"), l && (a.crossOrigin = l), a.onload = function (l) {
                return function () {
                    ...
                    return u = function (e) {
                        ...
                        var u, p, c, d, h, m, f, g;
                        switch (e.width = a.width, e.height = a.height, f = l.options.resize.call(l, e, t, i, n), u = document.createElement("canvas"), p = u.getContext("2d"), u.width = f.trgWidth, u.height = f.trgHeight, r > 4 && (u.width = f.trgHeight, u.height = f.trgWidth), r) {
                            case 2:
                            ...
                            case 5:
                                ...
                                break;
                            case 6:
                                p.rotate(.5 * Math.PI), p.translate(0, -u.height);
                                break;
                            case 7:
                                p.rotate(.5 * Math.PI), p.translate(u.width, -u.height), p.scale(-1, 1);
                                break;
                            case 8:
                                p.rotate(-.5 * Math.PI), p.translate(-u.width, 0)
                        }
                        if (o(p, a, null != (c = f.srcX) ? c : 0, null != (d = f.srcY) ? d : 0, f.srcWidth, f.srcHeight, null != (h = f.trgX) ? h : 0, null != (m = f.trgY) ? m : 0, f.trgWidth, f.trgHeight), g = u.toDataURL("image/png"), null != s) return s(g, u)
                    })
                }
            ...
            var t, i, r;
            for (i = 0, r = e.length; i < r; i++) (t = e[i]).processing = !0, t.status = n.UPLOADING, this.emit("processing", t);
            ...
            if (e.status === n.UPLOADING) {
                for (r = 0, o = (i = this._getFilesWithXhr(e.xhr)).length; r < o; r++) (t = i[r]).status = n.CANCELED;
                for (e.xhr.abort(), s = 0, l = i.length; s < l; s++) t = i[s], this.emit("canceled", t);
            ...
            var t, i, o, l, a, u, p, c, d, h, m, f, g, v, y, F, w, E, b, z, k, C, x, L, A, T, M, S, _, D, I, U, R, N, P,
                O;
            for (O = new XMLHttpRequest, g = 0, w = e.length; g < w; g++) (o = e[g]).xhr = O;
            C = s(this.options.method, e), N = s(this.options.url, e), O.open(C, N, !0), O.timeout = s(this.options.timeout, e), O.withCredentials = !!this.options.withCredentials, I = null, a = function (t) {
                return function () {
                    var i, n, r;
            ...
            for (v = 0, E = e.length; v < E; v++) o = e[v], this.emit("sending", o, O, l);
            if (this.options.uploadMultiple && this.emit("sendingmultiple", e, O, l), "FORM" === this.element.tagName) for (F = 0, b = (M = this.element.querySelectorAll("input, textarea, select, button")).length; F < b; F++) if (h = M[F], m = h.getAttribute("name"), f = h.getAttribute("type"), "SELECT" === h.tagName && h.hasAttribute("multiple")) for (k = 0, z = (S = h.options).length; k < z; k++) (L = S[k]).selected && l.append(m, L.value); else (!f || "checkbox" !== (_ = f.toLowerCase()) && "radio" !== _ || h.checked) && l.append(m, h.value);
            ...
            }(this), U.push(this.options.transformFile.call(this, e[d], i(e[d], this._getParamName(d), this._renameFilename(o.name, o))));
            return U
        }, n.prototype.submitRequest = function (e, t, i) {
            return e.send(t)
        }, n.prototype._finished = function (e, t, i) {
            var r, s, o;
            for (s = 0, o = e.length; s < o; s++) (r = e[s]).status = n.SUCCESS, this.emit("success", r, t, i), this.emit("complete", r);
            ...
            var r, s, o;
            for (s = 0, o = e.length; s < o; s++) (r = e[s]).status = n.ERROR, this.emit("error", r, t, i), this.emit("complete", r);
    ...
    }(t)).version = "5.0.1", e.options = {}, e.optionsForElement = function (t) {
        ...
        } else if ("string" == typeof e) for (n = [], s = 0, l = (a = document.querySelectorAll(e)).length; s < l; s++) i = a[s], n.push(i); else null != e.nodeType && (n = [e]);
        ...
        var i, n, r, s, o;
        if (!t) return !0;
        for (t = t.split(","), i = (s = e.type).replace(/\/.*$/, ""), n = 0, r = t.length; n < r; n++) if (o = t[n], "." === (o = o.trim()).charAt(0)) {
        ...
        return e.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e.encode64 = function (e) {
            ...
            for (u = "", t = void 0, i = void 0, n = "", r = void 0, s = void 0, o = void 0, l = "", a = 0; ;) if (t = e[a++], i = e[a++], n = e[a++], r = t >> 2, s = (3 & t) << 4 | i >> 4, o = (15 & i) << 2 | n >> 6, l = 63 & n, isNaN(i) ? o = l = 64 : isNaN(n) && (l = 64), u = u + this.KEY_STR.charAt(r) + this.KEY_STR.charAt(s) + this.KEY_STR.charAt(o) + this.KEY_STR.charAt(l), t = i = n = "", r = s = o = l = "", !(a < e.length)) break;
            return u
            ...
            var i, n, r, s, o, l;
            return s = e.replace("data:image/jpeg;base64,", ""), r = this.decode64(s), l = r.indexOf(255, 3), o = r.slice(0, l), n = r.slice(l), i = o, i = i.concat(t), i = i.concat(n)
            ...
            var t, i, n, r, s, o, l, a, u;
            for ("", i = void 0, n = void 0, r = "", s = void 0, o = void 0, l = void 0, a = "", u = 0, t = [], /[^A-Za-z0-9\+\/\=]/g.exec(e) && console.warning("There were invalid base64 characters in the input text.\nValid base64 characters are A-Z, a-z, 0-9, '+', '/',and '='\nExpect errors in decoding."), e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); ;) if (s = this.KEY_STR.indexOf(e.charAt(u++)), o = this.KEY_STR.indexOf(e.charAt(u++)), l = this.KEY_STR.indexOf(e.charAt(u++)), a = this.KEY_STR.indexOf(e.charAt(u++)), i = s << 2 | o >> 4, n = (15 & o) << 4 | l >> 2, r = (3 & l) << 6 | a, t.push(i), 64 !== l && t.push(n), 64 !== a && t.push(r), i = n = r = "", s = o = l = a = "", !(u < e.length)) break;
            return t
        }, e
    }(), r = function (e, t) {
