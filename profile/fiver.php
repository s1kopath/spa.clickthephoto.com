...
<div id="full">  
<center> 
<h1>Success Frelancer's - Fiver</h1>
<a href="index.php"><button class="button button4"><i class="fa fa-home"></i> </button></a>
<a href="upwork.php"><button class="button button4">Upwork ( 631 ) </button></a>
<a href="fiver.php"><button class="button button4">Fiver ( 728 ) </button></a>
</center><br>
<?php
require_once 'admin/admin/includes/conn.php';
$eq=mysqli_query($con,"select * from gallery  where type=2 ORDER BY id DESC   ");
while($eqrow=mysqli_fetch_array($eq)){
?>
<a target="_blank" href="view_profile_fiver.php?Profile=<?php echo $eqrow['id']; ?>"> 
<div id="title">  
