...
<?php
	...
	{ 
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('INSERT INTO gallery (user_id,name,designation,location,total_earn,total_job,total_hours,overview,link,type,userPic) 
															VALUES(:user_id,:Name,:Desi,:Location,:Earn,:Job,:Hours,:Overview,:Link,:MarkPlace,:upic)');
